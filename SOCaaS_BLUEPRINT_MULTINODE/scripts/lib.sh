...
: "${SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR:=/var/lib/libvirt/images/socaas}"
: "${SOCAAS_LIBVIRT_CLOUD_IMAGE_PATH:=${SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR}/ubuntu-22.04-server-cloudimg-amd64.img}"
...
SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR="${SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR%/}"
...
export SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR SOCAAS_LIBVIRT_CLOUD_IMAGE_PATH
...
validate_storage_paths() {
  ...
  [[ "${SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR}" == /var/lib/libvirt/images* ]] || fatal \
    "SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR must live under /var/lib/libvirt/images, not ${SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR}"
  [[ "${SOCAAS_LIBVIRT_CLOUD_IMAGE_PATH}" == "${SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR}/"* ]] || fatal \
    "SOCAAS_LIBVIRT_CLOUD_IMAGE_PATH must live under ${SOCAAS_LIBVIRT_CLOUD_IMAGE_DIR}, not ${SOCAAS_LIBVIRT_CLOUD_IMAGE_PATH}"
}
