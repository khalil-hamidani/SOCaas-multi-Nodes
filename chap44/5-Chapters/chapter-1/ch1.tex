...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{figs/Director general.png}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{figs/Division Systemes d'information.png}}
\caption{Organization Chart of the Information Systems Division}
\label{fig:ch1-organigramme-dsi}
\end{figure}
