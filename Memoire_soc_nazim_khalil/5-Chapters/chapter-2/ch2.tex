...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.75\textwidth]{figs/ThreatModeling.jpg}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=0.8\textwidth]{figs/CyberKillCycle.png}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{2cm}\textit{Figure 2.3 -- MITRE ATT\&CK Enterprise Matrix Tactics}\vspace{2cm}}}
\caption{MITRE ATT\&CK Enterprise Matrix Tactics}
\label{fig:mitre-tactics}
\end{figure}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{2cm}\textit{Figure 2.5 -- IDS Location}\vspace{2cm}}}
...
\begin{figure}[H]
\centering
\fbox{\parbox{0.8\textwidth}{\centering\vspace{2cm}\textit{Figure 2.6 -- IPS Location}\vspace{2cm}}}
